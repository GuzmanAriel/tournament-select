...
const PastTournamentCardBody = ({ item}) => {
    const { id, name, date_utc, start_time, tournament_type, playoff_elimination_type, location} = item;
   return (
    <>
        <CardBody>
            ...
            <div className="border-b-1 border-white justify-content-between mb-4 card-bottom">
                    <div className="justify-content-between align-items-center flex-wrap card-heading d-flex">
                ...
                <CardText className="d-flex justify-content-between align-items-center">
                    <div className="card-current-data__winner  mt-2">
                       <span className="card-first-place">
                        <img src={FirstPlaceIcon}  alt="First Place Icon"/>
                        </span>
                        <span>Austin Select</span>
                    </div>
...
export default PastTournamentCardBody;